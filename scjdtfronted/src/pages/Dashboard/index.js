    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-itens">
        ...
        <div className="itens">
          <h2>Escala Padrão</h2>
          <div className="button-group">
            <Link className="button" to="/scale-create">Inserir</Link>
            <Link className="button button-color" to="/scale-list">Consultar</Link>
          </div>
        </div>
        <div className="itens">
          <h2>Programação Férias</h2>
          <div className="button-group">
            <Link className="button" to="/vacation-create">Inserir</Link>
            <Link className="button button-color" to="/vacation-list">Consultar</Link>
          </div>
        </div>
      </div>
    </div>
